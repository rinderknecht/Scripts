...
MAIN="${SVN} ${LINK} Desktop SVN.dump bib misc .thunderbird git/ligo git/ASN.1 git/Book git/Caml_light-build git/Csharp_lexer git/Csharp_preprocessor git/CV git/LaTeX-build git/Mini-ML git/Music git/OCaml-build git/PhD git/Poetry git/Red-Black_Trees git/Scripts git/Singapore git/Ternary_Search_Trees git/UnionFind academia.html"
